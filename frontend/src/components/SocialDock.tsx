...
export default function SocialDock() {
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            ([entry]) => {
                // Hide dock when footer is visible to avoid overlap
    ...
    return (
        <div
            className={`${show ? "flex" : "hidden"} fixed z-50 pointer-events-none flex-col gap-2 md:gap-3 bottom-4 right-4 md:bottom-6 md:right-6`}
            style={{
        ...
        >
            <a
                ...
                className="pointer-events-auto w-10 h-10 md:w-12 md:h-12 rounded-full bg-white text-black shadow-lg ring-1 ring-gray-700 flex items-center justify-center motion-safe:transition-transform hover:scale-105 active:scale-95"
            >
                {/* GitHub logo */}
            ...
            <a
                ...
                className="pointer-events-auto w-10 h-10 md:w-12 md:h-12 rounded-full bg-black text-white shadow-lg ring-1 ring-gray-700 flex items-center justify-center motion-safe:transition-transform hover:scale-105 active:scale-95"
            >
                {/* X logo */}
            ...
            <a
                ...
                className="pointer-events-auto w-10 h-10 md:w-12 md:h-12 rounded-full bg-gray-800 text-white shadow-lg ring-1 ring-gray-700 flex items-center justify-center motion-safe:transition-transform hover:scale-105 active:scale-95"
            >
                {/* Globe icon */}
                <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" className="fill-white">
