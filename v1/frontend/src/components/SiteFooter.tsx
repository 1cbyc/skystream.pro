...
export default function SiteFooter() {
    return (
        <footer id="site-footer" className="border-t border-gray-800 bg-gray-900 text-gray-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-8 py-6 flex flex-col gap-4 pb-[env(safe-area-inset-bottom,0px)]">
                ...
                <nav className="flex items-center justify-center gap-3">
                    <a
                        ...
                        className="inline-flex items-center gap-2 justify-center rounded-full sm:rounded-lg w-12 h-12 sm:w-auto sm:h-auto px-0 sm:px-4 sm:py-3 bg-gray-800 hover:bg-gray-700 motion-safe:transition-colors text-sm font-medium"
                    ...
                    >
                        ...
                        <span className="hidden sm:inline">nsisong.com</span>
                    </a>
                </nav>
            </div>
        </footer>
